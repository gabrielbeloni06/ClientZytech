...
export default function AppointmentsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white font-sans selection:bg-purple-500/30 pb-20 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-[500px] h-[500px] bg-purple-900/10 blur-[120px] rounded-full pointer-events-none"></div>
      <div className="fixed bottom-0 right-0 w-[500px] h-[500px] bg-blue-900/10 blur-[120px] rounded-full pointer-events-none"></div>

      <div className="max-w-6xl mx-auto p-6 md:p-10 relative z-10 space-y-8">
                                        ...
                                        <div className="relative group">
                                            <input 
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    const newConfig = [...weekConfig]
                                                    newConfig[idx].slots = val.split(',').map(s => s.trim())
                                                    setWeekConfig(newConfig)
                                                }}
                                            />
